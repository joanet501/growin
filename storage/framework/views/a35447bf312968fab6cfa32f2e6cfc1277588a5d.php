  ...
  <body class="bg-dark d-flex justify-content-center align-items-center vh-100">
    ...
    >
      ...
      <div class="d-flex gap-1 justify-content-center mt-1">
        ...
        <a onclick="window.location='<?php echo e(url('/login')); ?>'" class="text-decoration-none text-info fw-semibold">Volver al inicio</a>
      </div>
    </div>
...
<?php /**PATH /home/joan/Documentos/GrowIn/resources/views/registro.blade.php ENDPATH**/ ?>